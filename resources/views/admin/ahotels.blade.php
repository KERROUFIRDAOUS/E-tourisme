    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/save-hotels" method="POST" enctype="multipart/form-data" >
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">Stars:</label>
                        ...
                        <table class="table">
                            ...
                            @foreach($hotels as $hotel)
                                <tr>
                                    ...
                                    <td> {{$hotel->content}} </td>
                                    <td>
                                        <a class="btn btn-success" href="{{route('hotel-edit',['id'=>$hotel->id])}}">Edit</a>
                                    </td>
                                    <td>
                                        <form action="{{ route('destroyh')}}" method="POST">
                                            {{csrf_field()}}
