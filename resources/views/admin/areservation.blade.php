                            ...
                            @foreach($reservations as $reservation)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form data-toggle="tooltip" data-placement="top" title="accepte" enctype="multipart/form-data" action="{{route('changer-status')}}" method="post" >
                                            @csrf
                                        ...
                                        <div   class="btn-group" role="group" aria-label="Third group">
                                            <form data-toggle="tooltip" data-placement="top" title="Refuse" enctype="multipart/form-data" action="{{route('changer-status')}}" method="post" >
                                                @csrf
                                                <input  name="reservation_id" type="hidden" value="{{$reservation->id}}"/>
